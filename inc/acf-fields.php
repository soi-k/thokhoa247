		...
		array(
			...
			'fields'   => array(
				...
				array(
					...
					'label'      => 'Dịch vụ nổi bật (3 thẻ)',
					'name'       => 'services_featured',
					'type'       => 'repeater',
					'layout'     => 'block',
					'button_label' => 'Thêm dịch vụ',
					'instructions' => 'Để trống → tự động lấy bài viết danh mục "dich-vu-noi-bat".',
					'sub_fields' => array(
						array( 'key' => 'field_sf_title', 'label' => 'Tiêu đề', 'name' => 'title', 'type' => 'text' ),
						array( 'key' => 'field_sf_desc',  'label' => 'Mô tả ngắn', 'name' => 'desc', 'type' => 'textarea', 'rows' => 2 ),
						array( 'key' => 'field_sf_link',  'label' => 'Đường dẫn', 'name' => 'link', 'type' => 'url' ),
						array( 'key' => 'field_sf_image', 'label' => 'Ảnh', 'name' => 'image', 'type' => 'image', 'return_format' => 'url' ),
					),
				),
				array(
					'key'        => 'field_services_grid',
					'label'      => 'Lưới dịch vụ (8 ô icon)',
					'name'       => 'services_grid',
					'type'       => 'repeater',
					'layout'     => 'table',
					'button_label' => 'Thêm dịch vụ',
					'sub_fields' => array(
						array( 'key' => 'field_sg_title', 'label' => 'Tên dịch vụ', 'name' => 'title', 'type' => 'text' ),
						array( 'key' => 'field_sg_desc',  'label' => 'Mô tả', 'name' => 'desc', 'type' => 'text' ),
						array( 'key' => 'field_sg_link',  'label' => 'Đường dẫn', 'name' => 'link', 'type' => 'url' ),
					),
				),
				array(
